...
# [表情符号和社交媒体]Emojis and social media
...
表情符号几乎可以增强任何用户体验。它们总是占有一席之地，从偶然的社交媒体使用到顶级的入网营销策略。
...
不管你是与不同部门沟通的设计团队的一员，还是企业的社交媒体经理，或者是介于两者之间的人。表情符号有助于传达语气和意图，而这两者在网上交流时经常会在翻译中丢失。
...
现在有一整代人都是伴随着表情符号长大的。表情符号不再是你可以忽略的风格附加，而是每天有多少在线用户交流的一个组成部分。如果你仍然怀疑，花几分钟在Facebook或Twitter上点击一下。如果看不到大量的表情符号，你将无法滚动超过一个页面。
...
所以，下次当你考虑对社交媒体进行全面改革，或者在你的网络营销活动中寻找一个全新的角度时，请在我们的表情符号备忘单上找到最完美的表情符号!